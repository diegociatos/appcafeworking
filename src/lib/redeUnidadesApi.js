...
const demoPerfil = { unidade_id: 'lux', status: 'rascunho', parecer: '', dados: { empresa: 'Unidade Parceira Demonstrativa', responsavel: 'Operador parceiro', endereco: 'Av. Principal, 1000, sala 201', cidade: 'Belo Horizonte', uf: 'MG', bairro: 'Centro', horarios: 'Segunda a sexta, 8h às 18h', caracteristicas: 'Coworking parceiro com recepção, estações, salas e guarda segura de correspondências.', acessibilidade: 'Acesso por elevador', estacionamento: 'Rotativo próximo', comodidades: 'Wi-Fi, café e recepção', servicos: ['endereco_fiscal', 'coworking', 'sala_hora', 'sala_privativa'], fotos: [], financeiroConferido: true, espacosConferidos: true } };
