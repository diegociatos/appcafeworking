...
-- >>>>>>>>>> supabase/migrations/20260604160000_clientes_rw.sql <<<<<<<<<<
...
-- >>>>>>>>>> supabase/migrations/20260604180000_app_state.sql <<<<<<<<<<
...
-- >>>>>>>>>> supabase/migrations/20260604200000_cobrancas_asaas.sql <<<<<<<<<<
...
-- >>>>>>>>>> supabase/migrations/20260604220000_config_fiscal_nacional.sql <<<<<<<<<<
...
-- >>>>>>>>>> supabase/migrations/20260604240000_signup_cliente.sql <<<<<<<<<<
...
-- >>>>>>>>>> supabase/migrations/20260605120000_grants_service_role.sql <<<<<<<<<<
...
-- >>>>>>>>>> supabase/migrations/20260605140000_grants_authenticated.sql <<<<<<<<<<
...
insert into public.unidades (id, franqueado_id, nome, endereco, cor, salas, ocupacao, membros, receita) values
  ('lux',     'fr_ciatos', 'Luxemburgo', 'Rua Guaicuí, 715 · BH/MG',         '#6E4E3B', 0, 0, 0, 0),
  ('est',     'fr_ciatos', 'Estoril',    'Av. Raja Gabaglia, 2000 · BH/MG',  '#0E4B4F',  0, 0, 0, 0)
on conflict (id) do nothing;

-- Equipe e clientes começam VAZIOS — cadastrados pela tela em produção.
-- (Sem dados fictícios.)
