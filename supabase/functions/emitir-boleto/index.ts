...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const input: EmitirBoletoInput = {
      ...
      pagador: {
        nome: body.sacado, documento: String(body.sacado_documento), email: body.sacado_email,
        cep: body.sacado_cep || undefined,
        logradouro: body.sacado_logradouro || undefined,
        numero: body.sacado_numero || undefined,
        bairro: body.sacado_bairro || undefined,
        cidade: body.sacado_cidade || undefined,
        uf: body.sacado_uf || undefined,
      },
